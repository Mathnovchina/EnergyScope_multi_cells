...
RegroupElements = {
    ...
    "Coal_US": ["COAL_US"],
    "Coal_IGCC": ["COAL_IGCC"],
    "Biomass Power": ["BIOMASS_TO_POWER"],
    ...
    "Ind Cogen": ["IND_COGEN_GAS", "IND_COGEN_WOOD", "IND_COGEN_WASTE", "IND_COGEN_COAL"],
    ...
    "DHN Tech": ["DHN_COGEN_GAS", "DHN_COGEN_WOOD", "DHN_COGEN_WASTE", "DHN_COGEN_COAL",
    ...
    "Industry CCS": ["INDUSTRY_CCS", "CO2_EMISSIONS"],
    ...
    "Shipping": ["CARGO_LFO", "CARGO_LNG", "CARGO_METHANOL",
                 "CARGO_FUELCELL_AMMONIA", "CARGO_RETRO_METHANOL",
                 "CARGO_RETRO_AMMONIA", "CARGO_FUELCELL_LH2"],
    "Aviation": ["PLANE_SHORT_HAUL", "PLANE_LONG_HAUL"],
    ...
    "To Methanol": ["SYN_METHANOLATION", "METHANE_TO_METHANOL", "BIOMASS_TO_METHANOL",
                    "BIOWASTE_TO_METHANOL"],
    "To Jet Fuel": ["BIOMASS_TO_JET_FUEL", "BIOWASTE_TO_JET_FUEL",
                    "DIESEL_TO_JET_FUEL", "POWER_TO_JET_FUEL"],
    "Haber Bosch": ["HABER_BOSCH"],
    "HVC": ["OIL_TO_HVC", "GAS_TO_HVC", "BIOMASS_TO_HVC", "METHANOL_TO_HVC"],
    "Elec Storage": ["BEV_BATT", "CAES"],
...
RegroupLayers = {
    ...
    "Aviation": ["AVIATION_SHORT_HAUL", "AVIATION_LONG_HAUL"],
    "Shipping": ["SHIPPING"],
    "CO2 Industry": ["CO2_INDUSTRY"],
    "CO2 Captured": ["CO2_CAPTURED"],
